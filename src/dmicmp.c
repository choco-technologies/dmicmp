...
dmod_dmicmp_api_declaration(1.0, dmicmp_t, _create, ( void ))
{
    ...
    struct dmicmp *instance = Dmod_Malloc(sizeof(*instance));
    if (instance == NULL)
    {
        return NULL;
    }
...
dmod_dmicmp_api_declaration(1.0, void, _destroy, ( dmicmp_t handle ))
{
    Dmod_Free(handle);
}

dmod_dmicmp_api_declaration(1.0, bool, _is_valid, ( dmicmp_t handle ))
{
